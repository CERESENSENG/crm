...
// Route::get('/show',[StudentController::class,'index'])->name('student_reg');
 ...
 Route::get('/registerPage', [StudentController::class, 'RegistrationPage1'])->name('register.page1');
Route::post('/registerPage', [StudentController::class, 'store'])->name('register.store1');
