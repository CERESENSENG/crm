                    ...
                    <div class="basic-form">
                        <form action="{{ route('search.payment') }}"   >
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                  <label>Payment  Option</label><select style="width:95%"  id="payment_option" name="payment_option" class="form-control">
              ...
              <tbody>
                  ...
                  @foreach ($studentList as $index => $student)
                      <tr>
                        ...
                        <td> {{ $student->student->firstname }} {{ $student->student->surname }} </td>
